...
let isProcessRunning = false; // تتبع حالة التشغيل
...
router.get('/', async (req, res) => {
    if (isProcessRunning) {
        return res.send({ message: "Process is already running" });
    }

    isProcessRunning = true; // تعيين حالة التشغيل
...
_©noureddineouafy_` }, { quoted: xeonses });
            ...
            isProcessRunning = false; // إعادة تعيين حالة التشغيل بعد الانتهاء من العملية
        }
    }
